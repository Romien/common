...
def task_12_list_suppliers_from_specified_countries(cur):
    ...
    cur.execute(
        """SELECT SupplierID, SupplierName, ContactName, City, Country FROM Suppliers WHERE Country 
        IN ('USA', 'UK', 'Japan');""")
    return cur.fetchall()
...
def task_13_list_products_from_sweden_suppliers(cur):
    ...
    cur.execute("""SELECT Products.ProductName FROM Products INNER JOIN Suppliers 
       ON Products.SupplierID=Suppliers.SupplierID WHERE Suppliers.Country='Sweden';""")
    return cur.fetchall()
...
def task_14_list_products_with_supplier_information(cur):
    ...
    # Suppliers.Country, Suppliers.City, Suppliers.SupplierName FROM Products 
    # INNER JOIN Suppliers ON Products.SupplierID = Suppliers.SupplierID;""")
    # return cur.fetchall()

    cur.execute("""SELECT p.ProductID, p.ProductName, p.Unit, p.Price, 
        s.Country, s.City, s.SupplierName FROM Products AS p 
